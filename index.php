    ...
    <center>
        ...
        <table border="1" cellpadding="10">
            <tr align="center">
                ...
                <?php if (isset($_SESSION['userId'])) { ?> <?php if ($_SESSION['userLevel'] == 2) { ?><td><a href="Sutarciu_modulis/skoluSarasas.php">Skolų sąrašas</a><br/><?php }} ?>
                    <?php if (isset($_SESSION['userId'])) { if ($_SESSION['userLevel'] == 1) { ?><td><a href="Sutarciu_modulis/skolosLangas.php">Skolos langas</a></td><?php }} ?>
                <?php if (isset($_SESSION['userId'])) { ?> <?php if ($_SESSION['userLevel'] == 1) { ?><td><a href="Sutarciu_modulis/rezervuotuKnyguSarasas.php">Knygų rezervacijų sąrašas</a></td><?php }} ?>
                <?php if (isset($_SESSION['userId'])) { ?> <?php if ($_SESSION['userLevel'] == 1) { ?><td><a href="lengvatuSarasas.php">Lengvatų sąrašas</a></td><?php }} ?>
